...
/** Mesmo padrão: contexto (variação) — Geral / PS / Leitos. */
const META = {
  dark: { label: 'Geral (escuro)', emoji: '🌙' },
  light: { label: 'Geral (claro)', emoji: '☀️' },
  'dark-green': { label: 'PS (verde)', emoji: '🌿' },
  'dark-blue': { label: 'Leitos (azul)', emoji: '💧' },
};
